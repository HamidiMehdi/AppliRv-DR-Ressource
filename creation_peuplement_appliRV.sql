...
--
-- Host: localhost    Database: GsbCRv5
-- ------------------------------------------------------
...
CREATE TABLE `RAPPORT_VISITE` (
  ...
  `RAP_MOTIF` varchar(20) NOT NULL,
  `RAP_COEFCONFIANCE` int(11) NOT NULL,
  `RAP_DATE_VISITE` date DEFAULT NULL,
  `RAP_DATE_CREATION` date NOT NULL,
  `RAP_EST_LU` varchar(10) NOT NULL DEFAULT '',
...
('t60',11,1,'Bilan15','Motif15',2,'2016-09-30','2016-10-02','Non Lu'),
('p49',6,18,'Bilan13','Motif13',3,'2016-09-02','2016-09-10','Non Lu'),
('a131',1,33,'Bilan1','Motif1',5,'2016-09-24','2016-09-26','Non Lu'),
('a17',4,10,'Bilan2','Motif2',3,'2016-08-11','2016-08-18','Non Lu'),
('b50',14,57,'Bilan5','Motif5',3,'2016-08-06','2016-08-06','Non Lu'),
('b50',16,57,'Bilan7','Motif7',2,'2016-09-15','2016-09-28','Non Lu'),
('b50',12,57,'Bilan3','Motif3',5,'2016-11-12','2016-11-14','Non Lu'),
('b50',13,57,'Bilan4','Motif4',5,'2016-11-15','2016-11-20','Non Lu'),
('e5',3,25,'Bilan8','Motif8',3,'2016-10-26','2016-10-26','Non Lu'),
('g30',7,23,'Bilan9','Motif9',3,'2016-10-15','2016-10-18','Non Lu'),
('g7',5,84,'Bilan10','Motif10',4,'2016-08-08','2016-08-28','Non Lu'),
('n58',8,26,'Bilan12','Motif12',2,'2016-09-26','2016-09-03','Non Lu'),
('b50',15,57,'Bilan6','Motif6',4,'2016-08-22','2016-08-23','Non Lu'),
('m35',2,71,'Bilan11','Motif11',5,'2016-09-26','2016-09-27','Non Lu'),
('p49',9,65,'Bilan14','Motif14',1,'2016-09-10','2016-09-15','Non Lu');
...
INSERT INTO `SPECIALITE` VALUES 
	...
	('GMO','gynécologie m?dicale, obstétrique'),
...
CREATE TABLE `VISITEUR` (
  ...
  `VIS_MDP` varchar(20) NOT NULL DEFAULT 'azerty',
...
INSERT INTO `VISITEUR` VALUES
	('a131','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08','E','SW','azerty'),
	('a17','Andre','David','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19','S','SW','azerty'),
	('a55','Bedos','Christian','1 rue Bénédictins','65000','TARBES','2007-09-07','S','SW','azerty'),
	('a93','Tusseau','Louis','22 rue Renou','86000','POITIERS','2001-02-09','O','SW','azerty'),
	('b13','Bentot','Pascal','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06','E','SW','azerty'),
	('b16','Bioret','Luc','1 rue Linne','35000','RENNES','2003-01-06','E','SW','azerty'),
	('b19','Bunisset','Francis','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23','O','SW','azerty'),
	('b25','Bunisset','Denise','1 rue Lionne','49100','ANGERS','2007-03-04','O','SW','azerty'),
	('b28','Cacheux','Bernard','114 rue Authie','34000','MONTPELLIER','2008-02-10','S','SW', 'azerty'),
	('b34','Cadic','Eric','123 rue Caponière','41000','BLOIS','2012-06-03','S','SW', 'azerty'),
	('b4','Charoze','Catherine','100 place Géants','33000','BORDEAUX','2009-05-07','S','SW', 'azerty'),
	('b50','Clepkens','Christophe','12 rue Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18','S','SW', 'azerty'),
	('b59','Cottin','Vincenne','36 square Capucins','5000','GAP','2010-12-19','S','SW','azerty'),
	('c14','Daburon','François','13 rue Champs Elysées','6000','NICE','2012-01-20','S','SW','azerty'),
	('c3','De','Philippe','13 rue Charles Peguy','10000','TROYES','2005-05-29','N','SW','azerty'),
	('c54','Debelle','Michel','181 rue Caponière','88000','EPINAL','2004-09-19','E','SW','azerty'),
	('d13','Debelle','Jeanne','134 rue Stalingrad','44000','NANTES','2012-05-25','O','SW','azerty'),
	('d51','Debroise','Michel','2 avenue 6 Juin','70000','VESOUL','2011-08-17','E','GY', 'azerty'),
	('e22','Desmarquest','Nathalie','14 rue Fédérico Garcia Lorca','54000','NANCY','2013-04-18','N','SW', 'azerty'),
	('e24','Desnost','Pierre','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','E','SW', 'azerty'),
	('e39','Dudouit','Frédéric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18','P','SW','azerty'),
	('e49','Duncombe','Claude','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16','S','SW', 'azerty'),
	('e5','Enault-Pascreau','Céline','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','S','GY', 'azerty'),
	('e52','Eynde','Valérie','3 rue Henri Moissan','76000','ROUEN','2012-09-16','O','SW', 'azerty'),
	('f21','Finck','Jacques','route Montreuil Bellay','74000','ANNECY','2012-09-16','E','SW', 'azerty'),
	('f39','Frémont','Fernande','4 rue Jean Giono','69000','LYON','2005-05-29','E','SW', 'azerty'),
	('f4','Gest','Alain','30 rue Authie','46000','FIGEAC','2005-05-29','S','SW', 'azerty'),
	('g19','Gheysen','Galassus','32 boulevard Mar Foch','75000','PARIS','2005-05-29','P','SW', 'azerty'),
	('g30','Girard','Yvon','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','N','GY', 'azerty'),
	('g53','Gombert','Luc','32 rue Emile Gueymard','56000','VANNES','2012-05-25','O','SW', 'azerty'),
	('g7','Guindon','Caroline','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25','O','SW', 'azerty'),
	('h13','Guindon','François','44 rue Picotière','19000','TULLE','2012-05-25','S','SW', 'azerty'),
	('h30','Igigabel','Guy','33 rue Arlequin','94000','CRETEIL','2008-06-19','P','SW', 'azerty'),
	('h35','Jourdren','Pierre','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19','S','SW', 'azerty'),
	('h40','Juttard','Pierre-Raoul','34 cours Jean Jaurès','8000','SEDAN','2008-06-19','E','SW', 'azerty'),
	('j45','Euré-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','N','SW', 'azerty'),
	('j50','Landré','Philippe','4 avenue du Général Laperrine','59000','LILLE','2000-05-01','N','SW', 'azerty'),
	('j8','Langeard','Hugues','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','P','GY', 'azerty'),   
	('k4','Lanne','Bernard','4 rue Bayeux','30000','NIMES','2000-05-01','S','SW', 'azerty'),
	('k53','Le','Noël','4 avenue Beauvert','68000','MULHOUSE','2000-05-01','E','SW', 'azerty'),
	('l14','Le','Jean','39 rue Raspail','53000','LAVAL','2000-05-01','S','SW', 'azerty'),
	('l23','Leclercq','Servane','11 rue Quinconce','18000','BOURGES','1998-11-23','O','SW', 'azerty'),
	('l46','Lecornu','Jean-Bernard','4 boulevard du Maréchal Foch','72000','LA FERTE BERNARD','1998-11-23','O','SW', 'azerty'),
	('l56','Lecornu','Ludovic','4 rue Abel Servien','25000','BESANCON','1998-11-23','S','SW', 'azerty'),
	('m35','Lejard','Agnès','4 rue Anthoard','82000','MONTAUBAN','1998-11-23','S','SW', 'azerty'),
	('m45','Lesaulnier','Pascal','47 rue Thiers','57000','METZ','1998-11-23','E','SW', 'azerty'),
	('n42','Letessier','Stéphane','5 chemin de Capuche','27000','EVREUX','1998-11-23','N','SW', 'azerty'),
	('n58','Loirat','Didier','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23','O','SW', 'azerty'),
	('n59','Maffezzoli','Thibaud','5 rue Chateaubriand','2000','LAON','2005-12-21','N','SW', 'azerty'),
	('o26','Mancini','Anne','5 rue D\'\'Agier','48000','MENDE','2005-12-21','S','SW', 'azerty'),
	('p32','Marcouiller','Gérard','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21','P','SW', 'azerty'),
	('p40','Michel','Jean-Claude','5 rue Gabriel Péri','61000','FLERS','2005-12-21','O','SW', 'azerty'),
	('p41','Montecot','Françoise','6 rue Paul Valéry','17000','SAINTES','2005-12-21','S','SW', 'azerty'),
	('p42','Notini','Veronique','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21','N','SW', 'azerty'),
	('p49','Onfroy','Den','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21','O','SW', 'azerty'),
	('p6','Pascreau','Charles','57 boulevard Mar Foch','64000','PAU','1997-03-30','S','SW', 'azerty'),
	('p7','Pernot','Claude-Noël','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02','S','SW', 'azerty'),
	('p8','Perrier','Maître','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23','S','SW', 'azerty'),
	('q17','Petit','Jean-Louis','7 rue Ernest Renan','50000','SAINT LO','2009-06-07','O','SW', 'azerty'),
	('r24','Piquery','Patrick','9 rue Vaucelles','14000','CAEN','2007-04-29','O','GY', 'azerty'),
	('r58','Quiquandon','Joëll','7 rue Ernest Renan','29000','QUIMPER','2006-09-30','O','SW', 'azerty'),
	('s10','Retailleau','Josselin','88 bis rue Saumuroise','39000','DOLE','2011-12-05','E','SW', 'azerty'),
	('s21','Retailleau','Pascal','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09','E','SW', 'azerty'),
	('t43','Souron','Maryse','7B rue Gay Lussac','21000','DIJON','2003-09-03','E','SW', 'azerty'),
	('t47','Tiphagne','Patrick','7B rue Gay Lussac','62000','ARRAS','1997-08-29','N','SW', 'azerty'),
	('t55','Tréhet','Alain','7D chemin Barral','12000','RODEZ','1994-11-29','S','SW', 'azerty'),
	('t60','Tusseau','Josselin','63 rue Bon Repos','28000','CHARTRES','1991-03-29','O','GY', 'azerty');
...
-- Dump completed on 2016-04-14 15:13:17
